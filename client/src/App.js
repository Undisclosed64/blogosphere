      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            ...
            element={<StoryDetails user={user}></StoryDetails>}
          />
          ...
          <Route
            ...
            element={<DeleteStory></DeleteStory>}
          />

          <Route
            exact
            path="/stories/:storyId/comments/:commentId"
            element={<CommentView user={user}></CommentView>}
          />

          <Route
            exact
            path="/stories/:storyId/comments/:commentId/delete"
          ...
          <Route
            exact
            path="/account"
            element={<Account user={user}></Account>}
          />
