      ...
      <nav className="nav">
        ...
        {!user ? (
          <div className="rhs-links" onClick={closeNav}>
            <Link to="/sign-in" className="navLinkRight" id="logInLink">
              Log in
            </Link>
          ...
          <div className="rhs-links" onClick={closeNav}>
            <Link to="/account" className="navLinkRight">
              Account
            </Link>
            <Link to="/log-out" className="navLinkRight" id="logOutLink">
              Log out
            </Link>
          </div>
        )}
